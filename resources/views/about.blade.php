                ...
                <main class="mt-6 gap-x-10">
                    ...
                    <a 
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl text-center font-semibold text-white dark:text-white">About Me</h2>

                                <p class="mt-4 text-xl/relaxed text-center">
                                Hi, I'm Cruciallity, also known as Ben. With over three years of experience as a configuration developer and manager for Minecraft servers, I bring a wealth of knowledge and expertise to the table. I own my own server, which gives me a deep understanding of both the technical and community aspects of server management. Additionally, I create valuable resources for BuiltByBit, showcasing my commitment to enhancing the Minecraft experience through innovation and dedication. My goal is to continue improving and expanding the Minecraft community with my skills and passion.
                                </p>
                            </div>
                        </a>
                    </div>
